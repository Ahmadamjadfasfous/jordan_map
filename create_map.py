...
# Load the Excel file
file_path = r'C:\\Users\\Lenovo\\OneDrive\\سطح المكتب\\map\\Book copy copy copy copy copy copy copy.xlsx'
...
# Wait for a specified amount of time before deleting the file (e.g., 10 seconds)
#time.sleep(1)
...
print("The map has been created, viewed, and deleted successfully.")
